...
export const translations: Translations = {
  ...
  footer_address: { uz: "Nukus, Qoraqalpog'iston", ru: "Нукус, Каракалпакстан", en: "Nukus, Karakalpakstan", kaa: "Nukus, Qaraqalpaqstan" },
  ...
  about_subtitle: { uz: " boy madaniy merosini va noyob tabiiy go'zalligini kashf eting", ru: "Откройте богатое культурное наследие и уникальную природную красоту Каракалпакстана", en: "Discover the rich cultural heritage and unique natural beauty of Karakalpakstan", kaa: "Qaraqalpaqstannıń bay mádeni murasın hám noyob tábiyiy gózalligin ashıń" },
